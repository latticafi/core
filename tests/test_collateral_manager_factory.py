...
def test_initial_state(
    collateral_manager_factory, collateral_manager_blueprint, deployer
):
    assert (
        collateral_manager_factory.implementation()
...
def test_deploy_cm_non_owner_reverts(
    collateral_manager_factory,
    lender,
    condition_id,
    mock_ctf,
...
def test_deploy_cm_duplicate_reverts(
    collateral_manager_factory,
    deployer,
    condition_id,
    mock_ctf,
